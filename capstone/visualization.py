...
"NFLX and DJI are by month, NFLX_daily_by_quarter represents it by days"
...
ax = sns.violinplot(data=netflix_stocks_quarterly,x='Quarter',y='Price', palette=sns.color_palette("RdBu", n_colors=4))
...
plt.scatter(x_positions, earnings_actual,color='green', alpha=0.5)
...
"Revenue and Earing are growing. ~5%"
